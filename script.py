...
        url = "https://gamesfreeonlinehub.blogspot.com/2026/04/epic-duck.html"
...
            context.close()
            browser.close()
            print(f"?? Sesi ke-{sesi_ke} gagal klik tombol pertama.")
            return

        tunggu_iklan = random.randint(15, 30)
